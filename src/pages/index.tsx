...
import { Box, Flex, Heading, HStack, Image, Link, Spinner, Text, useBreakpointValue } from "@chakra-ui/react";
              ...
              {data.books.map(book => (
                ...
                >
                  ...
                  >
                    ...
                    <Box>
                      <Text color="teal.400" fontWeight="bold">{book.volumeInfo.title}</Text>

                      <Text py='2'>{book.volumeInfo.publishedDate}</Text>
                    
                      <Text fontSize="sm" color="gray.300">{book.searchInfo?.textSnippet}</Text>
                    </Box>
                  </HStack>
                </Link>
              ))}
